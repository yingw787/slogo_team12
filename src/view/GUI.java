...
public class GUI {
	...
	public GUI(Controller controller, String language, ReadOnlyIntegerProperty myActiveTurtle) {
		...
		optionsBox.getChildren().add(myFactory.makeButton("pickImageButton", e -> this.pickImage()));
	...
	public void clearLines() {
		List<Node> newChildren = canvasBox.getChildren().stream()
				.filter(child -> !child.getClass().equals(new Line().getClass())).collect(Collectors.toList());
